        ...
        <div class="container container-tight py-4">
            <div class="text-center mb-4">
                <a href="#" class="navbar-brand navbar-brand-autodark">
                    <img src="{{ asset('assets/image/CNC_LOGO.webp') }}" width="auto" height="80" alt="Tabler">
                </a>
            </div>
            <div class="card card-md">
                <div class="card-body">
                    <h2 class="h2 text-center mb-4">Student Login For Test</h2>
                    <form action="{{ route('login.submit') }}" method="post" autocomplete="off">
                        ...
                        <div class="form-footer">
                            ...
                            <div class="btn btn-primary w-100">
                                <a class="text-white text-decoration-none" href="#">Student Login with Google</a>
                            </div> --}}
                        </div>
