    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="credentials">
                ...
                <p style="font-weight:800;">Please keep this information safe and secure. You must wait 24 hours after
                    registration to start the test.</p>
            </div>
            <div style="text-align: center; margin: 20px 0;">
                <a href="{{ $url }}" class="btn-login">Click to Login</a>
            </div>
